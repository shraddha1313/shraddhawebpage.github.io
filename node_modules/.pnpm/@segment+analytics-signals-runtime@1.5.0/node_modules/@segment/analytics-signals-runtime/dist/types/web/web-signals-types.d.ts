...
export interface URLChangeNavigationData extends BaseNavigationData<'urlChange'> {
    prevUrl: string;
}
export interface PageChangeNavigationData extends BaseNavigationData<'pageLoad'> {
}
...
export type Signal = InteractionSignal | NavigationSignal | InstrumentationSignal | NetworkSignal | UserDefinedSignal;
export {};
